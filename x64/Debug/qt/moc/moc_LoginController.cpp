...
static constexpr auto qt_meta_stringdata_ZN15LoginControllerE = QtMocHelpers::stringData(
    "LoginController",
    "loginSuccess",
    "",
    "loginFailed",
...
Q_CONSTINIT static const uint qt_meta_data_ZN15LoginControllerE[] = {
 ...
 // methods: name, argc, parameters, tag, flags, initial metatype offsets
       5,    0,   48,    2, 0x102,    4 /* Public | MethodIsConst  */,
       6,    0,   49,    2, 0x102,    5 /* Public | MethodIsConst  */,
       7,    2,   50,    2, 0x02,    6 /* Public */,
...
Q_CONSTINIT const QMetaObject LoginController::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN15LoginControllerE.offsetsAndSizes,
    qt_meta_data_ZN15LoginControllerE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN15LoginControllerE_t,
        // Q_OBJECT / Q_GADGET
...
void LoginController::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: { QString _r = _t->currentUserName();
            if (_a[0]) *reinterpret_cast< QString*>(_a[0]) = std::move(_r); }  break;
        case 3: { QString _r = _t->currentUserEmail();
            if (_a[0]) *reinterpret_cast< QString*>(_a[0]) = std::move(_r); }  break;
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (LoginController::*)();
            if (_q_method_type _q_method = &LoginController::loginSuccess; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _q_method_type = void (LoginController::*)(const QString & );
            if (_q_method_type _q_method = &LoginController::loginFailed; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
...
void *LoginController::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN15LoginControllerE.stringdata0))
